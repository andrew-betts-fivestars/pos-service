...
// import { CardReaderDevice } from '@instore/hardware/cardReader/types';
// import { HeartbeatMetrics } from '@instore/middleware/sagas/heartbeat/types';
// import { HealthAttributeName, HealthStateDatum } from '@instore/redux/health/types';
...
// import { HealthHeartbeatSnapshot, HealthStateSnapshot } from '../types';

export type WebSocketServerParameters = {
    action: string
    data: any
    onSuccess: null
};

export const sendWebSocketServer = (webSocketServerParameters: WebSocketServerParameters) => {
    return {
...
//  *
//  * @param heartbeatUuid A unique UUID for this heartbeat (ATM Machine, The El Niño, etc.)
