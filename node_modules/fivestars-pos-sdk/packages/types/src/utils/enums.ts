 ...
 */
export enum AnalyticsTrackerEventProperty {
    /*
    ...
    APP_TYPE = 'APP_TYPE', // there is an existing app type field called APP_TYPE.
    ...
    PAY_MANUAL_TXN_FLAG = 'pay_manual_txn_flag', // use for "session" event when that ticket is worked on!
    ...
    PAY_TXN_AMOUNT = 'pay_txn_amount', // total + tip + rewards
    ...
    ACTION = 'action',
    OUTCOME = 'outcome',
    PAY_CARD_REJECTED_BY = 'pay_card_rejected_by', // enum Rejector
    PAY_CARD_LINKED = 'pay_card_linked',
    PAY_CC_TOKEN_FOUND = 'pay_cc_token_found',
    PAY_FUNCTION = 'pay_function',
    PAY_INIT_STATUS = 'pay_init_status', // enum CardReadStatus
    ...
    PAY_TIP_TYPE = 'pay_tip_type', // use for "pay_tip_added" event when that ticket is worked on!
    USER_TIME = 'user_time',
...
export enum AnalyticsTrackerEventName {
    ...
    FULL_CARD_SWIPE = 'pay_full_card_swipe', // PAY_INIT_STATUS, PAY_USER_FOUND, PAY_CC_TOKEN_FOUND
    REFUND_TRANSACTION = 'pay_refund_transaction', // PAY_REFUNDED_TXN_UID, PAY_REFUND_AMOUNT
    REFUND_TRANSACTIONS_LIST = 'pay_refund_transactions_list', // PAY_REFUND_MATCH_COUNT PAY_REFUND_AMOUNT
    REWARD_DISPLAYED = 'pay_reward_screen_displayed',
    REWARD_SELECTED = 'pay_reward_selected', // SELECTED_REWARD_TYPE, SELECTED_REWARD_UID, SELECTED_PROMO_TRACKER_UID
    SIGN_IN_COMPLETE = 'pay_user_sign_in_complete', // PAY_NEW_USER_REGISTERED
    SIGN_IN_DISPLAYED = 'pay_user_sign_in_displayed',
    STRIPE_AUTH_DURATION = 'pay_stripe_auth_duration',
    STRIPE_AUTH_FAIL = 'pay_stripe_auth_failed', // PAY_INIT_STATUS
    ...
    CASH_BUTTON_PUSHED = 'pay_cash_button_pushed', // falco cash button
    CASH_RECIVED = 'pay_cash_received',
    CREDIT_BUTTON_PUSHED = 'pay_credit_button_pushed', // falco credit button
...
export enum AnalyticsTrackerButtonName {
...
export enum AnalyticsTrackerUiElement {
...
export enum AnalyitcsTrackerErrorMessage {
    BAD_DIP = 'badDip',
    BAD_SWIPE = 'badSwipe',
    BAD_NFC = 'badNfc'
}

export enum CardReaderEventPropertyValue {
...
export enum CardReaderEventHardwareDevice {
    EDYNAMO = 'MagTek eDynamo',
    DYNAWAVE = 'MagTek DynaWave',
    PAX_A920 = 'Pax A920'
}

export enum CardInputType {
...
export enum KeypadMaxLength {
    PHONE = 10,
    MONEY = 7
}

export enum PayTxnStatus {
    FAILURE = 'failure',
    SUCCESS = 'success'
}
...
export enum AnalyticsTrackerStatus {
    FAILURE = 'failure',
    OFFLINE = 'offline',
    SUCCESS = 'success',
    TIMEOUT = 'timeout'
...
export enum AnalyticsEventDatabaseOperation {
