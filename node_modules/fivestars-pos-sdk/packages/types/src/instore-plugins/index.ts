...
export namespace BatteryModule {
    ...
    export interface Battery extends Plugin {
        start(callback: (event: BatteryEvent) => void): void;
    }
}
export type BatteryEvent = BatteryModule.BatteryEvent;

export namespace BluetoothSerialModule {
    export interface BluetoothSerial extends Plugin {
...
export namespace ThermalModule {
    export interface SensorReadings {
        cpu: number;
    }

    export interface Thermal extends Plugin {
...
export namespace DeviceModule {
    ...
    export interface Device extends Plugin {
        getDeviceInfo(): DeviceInfo;
    }
}
export type DeviceInfo = DeviceModule.DeviceInfo;

export namespace DgramModule {
    ...
    export interface Dgram extends Plugin {
...
export type MessageResult = DgramModule.MessageResult;
...
export namespace DisplayModule {
    export interface Display extends Plugin {
        enterImmersive(): void;
        keepAwake(): void;
...
export namespace FileModule {
    export interface File extends Plugin {
...
export namespace KardReaderModule {
    ...
    export type CardReaderUpdate =
        | CardReaderConnectedUpdate
        | CardReaderUsbPermissionUpdate
        | CardReaderBatteryUpdate
        | CardReaderCardInsertedUpdate;
    ...
    export interface KardReader extends Plugin {
        ...
        registerTransactionStatusCallback(
            callback: (transactionStatus: CardReaderTransactionStatusEventMessage) => void
        ): void;
...
export namespace MetadataModule {
    ...
    export interface Metadata extends Plugin {
        setWebappMetadata(config: WebappMetadata): Promise<void>;
        setSessionId(sessionId: string): Promise<void>;
    }
}

export namespace NavigateModule {
    export interface Navigate extends Plugin {
        toWifiSettings(): void;
    }
}

export namespace SystemModule {
    export interface System extends Plugin {
...
export namespace SystemStatsModule {
    ...
    export interface SystemStats extends Plugin {
        getTrafficStats(): Promise<TrafficStats>;
        getRouterPings(count: number): Promise<{ routerPings: number[] }>;
...
export type SystemStatsInfo = SystemStatsModule.SystemStatsInfo;
export type Netstat = SystemStatsModule.Netstat;
export type NetworkInfo = SystemStatsModule.NetworkInfo;
export type TrafficStats = SystemStatsModule.TrafficStats;
export type WifiInfo = SystemStatsModule.WifiInfo;
...
export type HostPaymentType = 'cash' | 'credit';
...
export interface HostPlatform {
    platform: string;
    deviceType: string;
    // hardwareId from winpay could not be set
    hardwareId?: string;
    // tabpay populates device version, but winpay does not
...
export namespace PayModule {
    ...
    type StartRefundOrContinuePayment = { paymentAmount: { amount: number } };
    ...
    export interface Pay extends Plugin {
        ...
        openSettings(): void;
        setFeatures(features: { [key: string]: boolean }): void;
...
export type AvailableNetworkAffinity = {
    hasEthernet: boolean;
    hasWifi: boolean;
};

export namespace NetworkAffinityModule {
    export interface NetworkAffinity extends Plugin {
...
export namespace NetworkAlertsModule {
    export interface RssiUpdate {
        rssi: number;
        signalLevel: number;
    }

    export interface NetworkAlerts extends Plugin {
...
export namespace LedControllerModule {
    export type Animation = 'dip' | 'dip_error' | 'dip_end_screen' | 'swipe' | 'swipe_error' | 'end_screen';

    export interface LedController extends Plugin {
...
export namespace PropModule {
    export interface Prop extends Plugin {
...
export namespace ReceiptPrinterModule {
    ...
    export interface Header {
        ...
        phoneNumber: string; // NOTE: expected to be formatted by caller i.e. (555) 555-5555
        city: string;
        state: string;
        postalCode: string;
...
export interface Plugins {
    com: {
        fivestars: {
            instore: {
                battery?: { Battery: BatteryModule.Battery };
                bluetoothserial?: { BluetoothSerial: BluetoothSerialModule.BluetoothSerial };
                device?: { Device: DeviceModule.Device };
                display?: { Display: DisplayModule.Display };
                dgram?: { Dgram: DgramModule.Dgram };
                file?: { File: FileModule.File };
                kardreader?: { KardReader: KardReaderModule.KardReader };
                ledcontroller?: { LedController: LedControllerModule.LedController };
                metadata?: { Metadata: MetadataModule.Metadata };
                navigate?: { Navigate: NavigateModule.Navigate };
                networkaffinity?: { NetworkAffinity: NetworkAffinityModule.NetworkAffinity };
                networkalerts?: { NetworkAlerts: NetworkAlertsModule.NetworkAlerts };
                pay?: { Pay: PayModule.Pay };
                prop?: { Prop: PropModule.Prop };
                system?: { System: SystemModule.System };
                systemstats?: { SystemStats: SystemStatsModule.SystemStats };
                thermal?: { Thermal: ThermalModule.Thermal };
                receiptprinter?: { ReceiptPrinter: ReceiptPrinterModule.ReceiptPrinter };
            };
        };
    };
}
