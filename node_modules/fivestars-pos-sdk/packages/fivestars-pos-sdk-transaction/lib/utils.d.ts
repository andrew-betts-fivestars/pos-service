...
import { PaymentTypes } from '@fivestars-pos-sdk/types';
export declare enum EarlyCheckinModal {
...
export declare type InitiatePaymentOptions = {
    amount: Money;
    paymentType: PaymentTypes;
    transactionTotalUid: string | null;
    options?: Partial<ITransactionOptions>;
};
